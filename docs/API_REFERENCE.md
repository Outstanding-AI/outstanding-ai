...
- Contracts pin: `solvix-contracts==0.12.24` (`pyproject.toml`). Request models extend the contracts case-context bases (`CaseContextV2`, `PartyInfoV3`, `BehaviorInfoV3`, `ObligationInfoV3` + V3 history blocks).
