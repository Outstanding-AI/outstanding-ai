...
- **Triple LLM Support**: Primary Vertex AI (`gemini-2.5-flash`), fallback OpenAI `gpt-5.6-luna`, optional Anthropic Claude (Sonnet for drafts, Haiku for classification)
